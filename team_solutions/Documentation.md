...
In the top figure, we present a graph with a well defined maximum independent set, which was run through the classical simulator and produced the expected value. 
